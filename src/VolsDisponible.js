    ...
    <div className="admin-container">
      <header className="admin-header">
        ...
        <nav className="admin-nav">
          ...
          <a href="/Formulaire" className="admin-nav-link">ajouter vol</a>
      ...
      <main className="admin-main">
        ...
        <div className="admin-search-container">
          ...
          <a href="/Formulaire" className="admin-add-button" style={{ textDecoration: 'none' }}>
            Ajouter vol
          </a>
        </div>
              ...
              {filteredFlights.length > 0 ? (
                filteredFlights.map((flight) => (
                  <div key={flight.id} className="admin-flight-card">
                    ...
                    <button className="admin-consult-button">Consulter</button>
                  </div>
                ))
              ) : (
                <div style={{ textAlign: 'center', padding: '40px', color: '#666' }}>
